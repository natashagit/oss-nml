...
from ai_client_service.models import ChatCompletionRequest, ChatMessage
...
def test_oauth_authorize(client):
...
def test_oauth_callback_failure(client):
...
def test_chat_completion_success(mock_get_client, client, mock_ai_client):
...
@patch("ai_client_service.main.get_ai_client")
def test_chat_completion_stream(mock_get_client, client, mock_ai_client):
...
@patch("ai_client_service.main.get_ai_client")
def test_chat_completion_missing_user_id(mock_get_client, client):
