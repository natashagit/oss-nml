...
T = TypeVar("T", bound="CommandResponseAiResultType0")
...
class CommandResponseAiResultType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        command_response_ai_result_type_0 = cls()

        command_response_ai_result_type_0.additional_properties = d
        return command_response_ai_result_type_0
